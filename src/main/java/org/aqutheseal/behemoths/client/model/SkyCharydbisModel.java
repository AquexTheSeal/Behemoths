...
public class SkyCharydbisModel<T extends SkyCharydbis> extends HierarchicalModel<T>  {
	...
	public float rad(float degAng) {
		return degAng * Mth.DEG_TO_RAD;
	}
	...
	public List<ModelPart> leftFinParts() {
		return List.of(finthingl, finthingl2, finthingl3, finthingl4, finthingl5);
	}

	public List<ModelPart> rightFinParts() {
		return List.of(finthingr, finthingr2, finthingr3, finthingr4, finthingr5);
	}

	public List<ModelPart> leftStringParts() {
		return List.of(stringl, stringl2, stringl3);
	}

	public List<ModelPart> rightStringParts() {
		return List.of(stringr, stringr2, stringr3);
	}

	public List<ModelPart> chainableParts() {
		return List.of(bodyin, bodyin2, bodyin3, bodyin4);
	}
