...
import org.celestialworkshop.behemoths.client.renderers.layers.HollowborneSaddleLayer;
...
public class HollowborneRenderer extends MobRenderer<Hollowborne, HollowborneModel<Hollowborne>> {
    ...
    public HollowborneRenderer(EntityRendererProvider.Context pContext) {
        super(pContext, new HollowborneModel<>(pContext.bakeLayer(HollowborneModel.LAYER_LOCATION)), 5.0F);
        this.addLayer(new HollowborneSaddleLayer(this, pContext.getModelSet()));
    }
