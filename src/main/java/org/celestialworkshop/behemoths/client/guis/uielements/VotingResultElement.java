...
public class VotingResultElement extends AnimatedUIElement<VotingResultsScreen> {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        guiGraphics.hLine(getRenderX() - 61, getRenderX() + 100, getRenderY() - 38, -1);

        guiGraphics.drawWordWrap(minecraft.font, winnerCurse.getDescription(), getRenderX() - 60, getRenderY() - 32, 160, 0xffffff);
    }
