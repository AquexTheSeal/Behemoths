...
public class BMEntityLoot extends EntityLootSubProvider {
    ...
    public void generate() {
         this.add(BMEntityTypes.ARCHZOMBIE.get(), LootTable.lootTable()
                 ...
                 .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1, 2)).add(LootItem.lootTableItem(BMItems.SAVAGE_FLESH.get())
        ...
        this.add(BMEntityTypes.HOLLOWBORNE.get(), LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1, 2)).add(LootItem.lootTableItem(BMItems.COLOSSUS_BONE.get())
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F)))
                        .apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(0.0F, 1.0F)))
                ))
