...
public class BMLootModifiers {
    ...
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> CURSE_SCALABLE_LOOT_MODIFIER = LOOT_MODIFIERS.register("curse_scalable_loot_modifier", () -> CurseScalableLootModifier.CODEC);
}
